  ...
  const GridItemHeadlineBlock = () => (
    <Box>
      ...
      <Typography
        ...
        data-aos={isMd ? 'fade-right' : 'fade-up'}
      >
        Mix and match different widgets to your liking!
      </Typography>
    </Box>
  );
        ...
        <Slider {...sliderOpts}>
          {[
            ...
            },
            {
              title: 'Design',
              subtitle:
                'With our widget editor, design and choose the layout to your liking',
              icon: (
                <svg
                  width={48}
                  height={48}
            ...
            },
            {
              title: 'Development',
              subtitle:
                'Get the profile up in less that 5 minutes!',
              icon: (
                <svg
                  width={48}
                  height={48}
